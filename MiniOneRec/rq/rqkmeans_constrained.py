...
def parse_args():
    ...
    parser.add_argument('--root', type=str, default="./data/Amazon", help="Input root directory or full .npy embedding path")
    parser.add_argument('--output_root', type=str, default=None, help="Output directory for generated files")
...
if __name__ == "__main__":
    ...
    if args.root.endswith(".npy"):
        data_path = args.root
        default_output_dir = os.path.dirname(args.root) or "."
    else:
        data_path = os.path.join(args.root, args.dataset + '.emb-qwen-td.npy')
        default_output_dir = args.root
    ...
    # Save codebooks
    output_dir = args.output_root if args.output_root else default_output_dir
